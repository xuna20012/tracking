      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          ...
          <div style="margin-top: 20px; text-align: center; border-top: 1px solid #e0e0e0; padding-top: 20px;">
            <img src="${process.env.NEXT_PUBLIC_APP_URL || 'logistique.ohgarage.com'}/images/ohpieces.png" alt="Oh Pieces Logistique" style="max-width: 150px; height: auto; margin-bottom: 10px;">
